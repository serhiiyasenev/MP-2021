...
namespace Task2
{
    public static class ObjectExtensions
    {
        public static void SetReadOnlyProperty(this object obj, string propertyName, object newValue)
        {
            ...
            if (property == null)
                throw new MemberNotFoundException($"The property with name {propertyName} was not found.");
        ...
        public static void SetReadOnlyField(this object obj, string filedName, object newValue)
        {
            ...
            if (field == null)
                throw new MemberNotFoundException($"The field with name {filedName} was not found.");
