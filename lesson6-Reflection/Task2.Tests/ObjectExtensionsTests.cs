...
namespace Task2.Tests
{
    ...
    public class ObjectExtensionsTests
    {
        ...
        public void SetReadOnlyField_Parent_SetFiledTo555()
        {
            ...
            obj.SetReadOnlyField(nameof(obj.Field), newValue);

            Assert.That(obj.Field, Is.EqualTo(newValue));
        }
        ...
        public void SetReadOnlyField_Child_SetPropertiesTo42and22()
        {
            ...
            obj.SetReadOnlyField(nameof(obj.Field), fieldNewValue);
            obj.SetReadOnlyField(nameof(obj.ChildField), childFieldNewValue);

            Assert.That(obj.Field, Is.EqualTo(fieldNewValue));
