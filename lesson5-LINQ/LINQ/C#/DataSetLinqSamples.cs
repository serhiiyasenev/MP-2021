...
#region "Restriction Operators"
        ...
        [SampleSupport.Category("Restriction Operators")]
        [Title("Where - Simple 1")]
        [SampleSupport.Description("This sample uses where to find all elements of an array less than 5.")]
        [Test]
        ...
        [SampleSupport.Description("This sample uses where to find all products that are out of stock.")]
        ...
        [SampleSupport.Description("This sample uses where to find all products that are in stock and " +
        ...
        [SampleSupport.Description("This sample uses where to find all customers in Washington " +
        ...
        [SampleSupport.Category("Restriction Operators")]
        [Title("Where - Indexed")]
        [SampleSupport.Description("This sample demonstrates an indexed Where clause that returns digits whose name is " +
        ...
        [SampleSupport.Category("Restriction Operators")]
        [Title("Single - Simple")]
        [SampleSupport.Description("Turns a sequence into a single result")]
        ...
        [SampleSupport.Description("Returns a single element based on the specified predicate")]
...
#region "Projection Operators"
        ...
        [SampleSupport.Category("Projection Operators")]
        [Title("Select - Simple 1")]
        [SampleSupport.Description("This sample uses select to produce a sequence of ints one higher than " +
        ...
        [SampleSupport.Description("This sample uses select to return a sequence of just the names of a list of products.")]
        ...
        [SampleSupport.Description("This sample uses select to produce a sequence of strings representing " +
        ...
        [SampleSupport.Description("This sample uses select to produce a sequence of the uppercase " +
        ...
        [SampleSupport.Description("This sample uses select to produce a sequence containing text " +
        ...
        [SampleSupport.Description("This sample uses select to produce a sequence containing some properties " +
        ...
        [SampleSupport.Description("This sample uses an indexed Select clause to determine if the value of ints " +
        ...
        [SampleSupport.Description("This sample combines select and where to make a simple query that returns " +
        ...
        [SampleSupport.Description("This sample uses a compound from clause to make a query that returns all pairs " +
        ...
        [SampleSupport.Description("This sample uses a compound from clause to select all orders where the " +
        ...
        [SampleSupport.Description("This sample uses multiple from clauses so that filtering on customers can " +
        ...
        [SampleSupport.Description("This sample uses an indexed SelectMany clause to select all orders, " +
...
#region "Partioning Operators"
        ...
        [SampleSupport.Category("Partitioning Operators")]
        [Title("Take - Simple")]
        [SampleSupport.Description("This sample uses Take to get only the first 3 elements of " +
                                   "the array.")]
        ...
        [SampleSupport.Category("Partitioning Operators")]
        [Title("Take - Nested")]
        [SampleSupport.Description("This sample uses Take to get the first 3 orders from customers " +
                                   "in Washington.")]
        ...
        [SampleSupport.Category("Partitioning Operators")]
        [Title("Skip - Simple")]
        [SampleSupport.Description("This sample uses Skip to get all but the first 4 elements of " +
                                   "the array.")]
        ...
        [SampleSupport.Category("Partitioning Operators")]
        [Title("Skip - Nested")]
        [SampleSupport.Description("This sample uses Skip to get all but the first 2 orders from customers " +
                                   "in Washington.")]
        ...
        [SampleSupport.Description("This sample uses TakeWhile to return elements starting from the " +
        ...
        [SampleSupport.Description("This sample uses SkipWhile to get the elements of the array " +
...
#region "Ordering Operators"
        ...
        [SampleSupport.Category("Ordering Operators")]
        [Title("OrderBy - Simple 1")]
        [SampleSupport.Description("This sample uses orderby to sort a list of words alphabetically.")]
        ...
        [SampleSupport.Description("This sample uses orderby to sort a list of words by length.")]
        ...
        [SampleSupport.Description("This sample uses orderby to sort a list of products by name.")]
        ...
        [SampleSupport.Description("This sample uses an OrderBy clause with a custom comparer to " +
        ...
        [SampleSupport.Description("This sample uses orderby and descending to sort a list of " +
        ...
        [SampleSupport.Description("This sample uses orderby to sort a list of products by units in stock " +
        ...
        [SampleSupport.Category("Ordering Operators")]
        [Title("ThenBy - Simple")]
        [SampleSupport.Description("This sample uses a compound orderby to sort a list of digits, " +
        ...
        [SampleSupport.Description("This sample uses an OrderBy and a ThenBy clause with a custom comparer to " +
        ...
        [SampleSupport.Description("This sample uses a compound orderby to sort a list of products, " +
        ...
        [SampleSupport.Category("Ordering Operators")]
        [Title("Reverse")]
        [SampleSupport.Description("This sample uses Reverse to create a list of all digits in the array whose " +
        ...
        [SampleSupport.Category("Grouping Operators")]
        [Title("GroupBy - Simple 1")]
        [SampleSupport.Description("This sample uses group by to partition a list of numbers by " +
        ...
        [SampleSupport.Description("This sample uses group by to partition a list of words by " +
                                   "their first letter.")]
        ...
        [SampleSupport.Description("This sample uses group by to partition a list of products by category.")]
        ...
        [SampleSupport.Description("This sample uses group by to partition a list of each customer's orders, " +
        ...
        [SampleSupport.Description("This sample uses GroupBy to partition trimmed elements of an array using " +
...
#region "Set Operators"
        ...
        [SampleSupport.Category("Set Operators")]
        [Title("Distinct - 1")]
        [SampleSupport.Description("This sample uses Distinct to remove duplicate elements in a sequence of " +
                                   "factors of 300.")]
        ...
        [SampleSupport.Category("Set Operators")]
        [Title("Distinct - 2")]
        [SampleSupport.Description("This sample uses Distinct to find unique employees")]
        ...
        [SampleSupport.Category("Set Operators")]
        [Title("Union - 1")]
        [SampleSupport.Description("This sample uses Union to create one sequence that contains the unique values " +
                                   "from both arrays.")]
        ...
        [SampleSupport.Category("Set Operators")]
        [Title("Union - 2")]
        [SampleSupport.Description("This sample uses Union to create one sequence based on two DataTables.")]
        ...
        [SampleSupport.Category("Set Operators")]
        [Title("Intersect - 1")]
        [SampleSupport.Description("This sample uses Intersect to create one sequence that contains the common values " +
        ...
        [SampleSupport.Category("Set Operators")]
        [Title("Intersect - 2")]
        [SampleSupport.Description("This sample uses Intersect to create one sequence based on two DataTables.")]
        ...
        [SampleSupport.Category("Set Operators")]
        [Title("Except - 1")]
        [SampleSupport.Description("This sample uses Except to create a sequence that contains the values from numbersA" +
        ...
        [SampleSupport.Category("Set Operators")]
        [Title("Except - 2")]
        [SampleSupport.Description("This sample uses Except to create one sequence based on two DataTables.")]
...
#region "Conversion Operators"
        ...
        [SampleSupport.Category("Conversion Operators")]
        [Title("ToArray")]
        [SampleSupport.Description("This sample uses ToArray to immediately evaluate a sequence into an array.")]
        ...
        [SampleSupport.Category("Conversion Operators")]
        [Title("ToList")]
        [SampleSupport.Description("This sample uses ToList to immediately evaluate a sequence into a List<T>.")]
        ...
        [SampleSupport.Category("Conversion Operators")]
        [Title("ToDictionary")]
        [SampleSupport.Description("This sample uses ToDictionary to immediately evaluate a sequence and a " +
        ...
        [SampleSupport.Category("Conversion Operators")]
        [Title("OfType")]
        [SampleSupport.Description("This sample uses OfType to return to return IEnumerable<DataRow>")]
...
#region "Element Operators"
        ...
        [SampleSupport.Category("Element Operators")]
        [Title("First - Simple")]
        [SampleSupport.Description("This sample uses First to return the first matching element " +
        ...
        [SampleSupport.Description("This sample uses First to find the first element in the array that starts with 'o'.")]
        ...
        [SampleSupport.Category("Element Operators")]
        [Title("ElementAt")]
        [SampleSupport.Description("This sample uses ElementAt to retrieve the second number greater than 5 " +
                                   "from an array.")]
        ...
        [SampleSupport.Description("This sample uses the DefaultIfEmpty operator to return a user specific default value if the source sequence contains is empty.")]
...
#region "Generation Operators"
        ...
        [SampleSupport.Category("Generation Operators")]
        [Title("Range")]
        [SampleSupport.Description("This sample uses Range to generate a sequence of numbers from 100 to 149 " +
        ...
        [SampleSupport.Category("Generation Operators")]
        [Title("Repeat")]
        [SampleSupport.Description("This sample uses Repeat to generate a sequence that contains the number 7 ten times.")]
...
#region "Quantifiers"
        ...
        [SampleSupport.Category("Quantifiers")]
        [Title("Any - Simple")]
        [SampleSupport.Description("This sample uses Any to determine if any of the words in the array " +
        ...
        [SampleSupport.Category("Quantifiers")]
        [Title("Any - Grouped")]
        [SampleSupport.Description("This sample uses Any to return a grouped a list of products only for categories " +
        ...
        [SampleSupport.Category("Quantifiers")]
        [Title("All - Simple")]
        [SampleSupport.Description("This sample uses All to determine whether an array contains " +
                                   "only odd numbers.")]
        ...
        [SampleSupport.Category("Quantifiers")]
        [Title("All - Grouped")]
        [SampleSupport.Description("This sample uses All to return a grouped a list of products only for categories " +
        ...
        [SampleSupport.Category("Quantifiers")]
        [Title("Contains")]
        [SampleSupport.Description("This sample uses the Contains operator to check to see if the source sequence contains a particular instance of a DataRow.")]
...
#region "Aggregate Operators"
        ...
        [SampleSupport.Category("Aggregate Operators")]
        [Title("Count - Simple")]
        [SampleSupport.Description("This sample uses Count to get the number of unique factors of 300.")]
        ...
        [SampleSupport.Description("This sample uses Count to get the number of odd ints in the array.")]
        ...
        [SampleSupport.Category("Aggregate Operators")]
        [Title("Count - Nested")]
        [SampleSupport.Description("This sample uses Count to return a list of customers and how many orders " +
                                   "each has.")]
        ...
        [SampleSupport.Category("Aggregate Operators")]
        [Title("Count - Grouped")]
        [SampleSupport.Description("This sample uses Count to return a list of categories and how many products " +
                                   "each has.")]
        ...
        [SampleSupport.Description("Gets the count as a long")]
        ...
        [SampleSupport.Description("This sample uses Count to get the number of odd ints in the array as a long")]
        ...
        [SampleSupport.Description("This sample uses Sum to get the total number of characters of all words " +
                                   "in the array.")]
        ...
        [SampleSupport.Category("Aggregate Operators")]
        [Title("Sum - Grouped")]
        [SampleSupport.Description("This sample uses Sum to get the total units in stock for each product category.")]
        ...
        [SampleSupport.Description("This sample uses Min to get the length of the shortest word in an array.")]
        ...
        [SampleSupport.Category("Aggregate Operators")]
        [Title("Min - Grouped")]
        [SampleSupport.Description("This sample uses Min to get the cheapest price among each category's products.")]
        ...
        [SampleSupport.Category("Aggregate Operators")]
        [Title("Min - Elements")]
        [SampleSupport.Description("This sample uses Min to get the products with the cheapest price in each category.")]
        ...
        [SampleSupport.Description("This sample uses Max to get the length of the longest word in an array.")]
        ...
        [SampleSupport.Category("Aggregate Operators")]
        [Title("Max - Grouped")]
        [SampleSupport.Description("This sample uses Max to get the most expensive price among each category's products.")]
        ...
        [SampleSupport.Category("Aggregate Operators")]
        [Title("Max - Elements")]
        [SampleSupport.Description("This sample uses Max to get the products with the most expensive price in each category.")]
        ...
        [SampleSupport.Description("This sample uses Average to get the average length of the words in the array.")]
        ...
        [SampleSupport.Description("This sample uses Average to get the average price of each category's products.")]
        ...
        [SampleSupport.Description("This sample uses Aggregate to create a running account balance that " +
...
#region "Miscellaneous Operators"
        ...
        [SampleSupport.Category("Miscellaneous Operators")]
        [Title("Concat - 1")]
        [SampleSupport.Description("This sample uses Concat to create one sequence that contains each array's " +
        ...
        [SampleSupport.Category("Miscellaneous Operators")]
        [Title("Concat - 2")]
        [SampleSupport.Description("This sample uses Concat to create one sequence that contains the names of " +
        ...
        [SampleSupport.Description("This sample uses SequenceEqual to see if two sequences match on all elements " +
                                   "in the same order.")]
        ...
        [SampleSupport.Category("Custom Sequence Operators")]
        [Title("Combine")]
        [SampleSupport.Description("This sample uses a user-created sequence operator, Combine, to calculate the " +
        ...
        [SampleSupport.Category("Query Execution")]
        [Title("ToLookup - element selector")]
        [SampleSupport.Description("The following sample shows how queries can be executed immediately with operators " +
                                   "such as ToLookup().")]
        ...
        [SampleSupport.Category("Query Execution")]
        [Title("Query Reuse")]
        [SampleSupport.Description("The following sample shows how, because of deferred execution, queries can be used " +
...
#region "DataSet Loading examples"
        ...
        [SampleSupport.Category("DataSet Loading examples")]
        [Title("Loading query results into a DataTable")]
        [SampleSupport.Description("Create and load a DataTable from a sequence")]
        ...
        [SampleSupport.Description("Load an existing DataTable with query results")]
...
#region "Linq over TypedDataSet"
        ...
        [SampleSupport.Category("LINQ over TypedDataSet")]
        [Title("TypedDataSet - simple")]
        [SampleSupport.Description("Simple queries using typed dataset")]
        ...
        [SampleSupport.Description("Projection using typed dataset")]
...
#region "Join Operators"
        ...
        [SampleSupport.Category("Join Operators")]
        [Title("Join - simple")]
        [SampleSupport.Description("Simple join over two tables")]
        ...
        [SampleSupport.Description("Join with grouped results")]
        ...
        [SampleSupport.Category("Join Operators")]
        [Title("Group Join")]
        [SampleSupport.Description("Simple group join")]
